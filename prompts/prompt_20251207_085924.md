...
- **Network:** `devnet`
- **Package ID:** `0xadf8a6af2d63558f69f25e5dc4a9f7f732868dc9eb18c33b2c133043c92c0a08`
- **Module Name:** `contract`
- **Available Methods:**

  * `create` (constant: `CREATE`)
  * `increment` (constant: `INCREMENT`)
  * `add_score` (constant: `ADD_SCORE`)
...
public fun add_score(counter: &mut HeroesGuessDapp, score: u64, ctx: &TxContext) {
assert!(counter.owner == ctx.sender(), 0);
counter.value = counter.value + score;
}
...
export const useContract = () => {
  ...
  const addScore = async (score: number) => {
    ...
    try {
      ...
      const tx = new Transaction()
      tx.moveCall({
        arguments: [tx.object(objectId), tx.pure.u64(score)],
        target: `${packageId}::${CONTRACT_MODULE}::${CONTRACT_METHODS.ADD_SCORE}`,
      })
...
- Use Package ID: `0xadf8a6af2d63558f69f25e5dc4a9f7f732868dc9eb18c33b2c133043c92c0a08` and Module: `contract`
